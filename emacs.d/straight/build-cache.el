...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("org-elpa" ("2019-11-17 20:07:47" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2019-11-17 20:07:47" nil (:type git :host github :repo "melpa/melpa" :no-build t :package "melpa" :local-repo "melpa")) "straight" ("2019-11-17 20:07:47" ("emacs") (:type git :host github :repo "raxod502/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "dracula-theme" ("2019-11-17 20:07:47" ("emacs") (:type git :flavor melpa :host github :repo "dracula/emacs" :package "dracula-theme" :local-repo "emacs"))))
...
(fn)" t nil) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "straight" (quote ("straight-")))) (defvar straight-x-pinned-packages nil "List of pinned packages.") (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "straight-x" (quote ("straight-x-")))) (provide (quote straight-autoloads))) "dracula-theme" ((dracula-theme-autoloads dracula-theme) (when load-file-name (add-to-list (quote custom-theme-load-path) (file-name-as-directory (file-name-directory load-file-name)))) (provide (quote dracula-theme-autoloads)))))

#s(hash-table size 65 test eq rehash-size 1.5 rehash-threshold 0.8125 data (org-elpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 1 "dracula-theme" nil)) melpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "dracula-theme" (dracula-theme :type git :flavor melpa :host github :repo "dracula/emacs")))))

("org-elpa" "melpa" "gnu-elpa-mirror" "emacsmirror-mirror" "straight" "emacs" "dracula-theme")
